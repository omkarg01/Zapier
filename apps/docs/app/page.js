...
const ThemeImage = (props) => {
    const { srcLight, srcDark } = props, rest = __rest(props, ["srcLight", "srcDark"]);
    return (<>
    ...
    return (<div className={page_module_css_1.default.page}>
      <main className={page_module_css_1.default.main}>
        ...
        <div className={page_module_css_1.default.ctas}>
          ...
          <a href="https://turborepo.com/docs?utm_source" target="_blank" rel="noopener noreferrer" className={page_module_css_1.default.secondary}>
            Read our docs
          </a>
        </div>
        <button_1.Button appName="docs" className={page_module_css_1.default.secondary}>
          Open alert
        </button_1.Button>
      </main>
